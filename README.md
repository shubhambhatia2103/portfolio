...
***Technologies/Framework:***&ensp;Github, Machine learning libraries, TensorFlow/Keras (Deep Learning), LangChain API, Natural Language Processing (NLP), Docker, Streamlit.
